...
const static QRegExp include_option = QRegExp("(#(i|I)(n|N)(c|L)(u|U)(d|D)(e|E))");
...
const static QRegExp option_line = QRegExp("^(\\s*)("+name_option.pattern()+"|"+init_option.pattern()+"|"+halt_option.pattern()+"|"+tape_option.pattern()+"|"+include_option.pattern()+")(\\s+)(\\S+)(\\s*)$");
//Lines
